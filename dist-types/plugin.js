...
export const AgileAnalyticsPage = agileAnalyticsPlugin.provide(createRoutableExtension({
    name: 'AgileAnalyticsPage',
    component: () => import('./components/AaMainComponent').then(m => m.AaMainComponent),
