...
const agileAnalyticsPluginPlugin = createPlugin({
  id: "agile-analytics",
  apis: [
    createApiFactory({
...
const AgileAnalyticsPluginPage = agileAnalyticsPluginPlugin.provide(
  createRoutableExtension({
    name: "Agile Analytics Plugin Page",
    component: () => import('./index-e4968a5d.esm.js').then(
...
export { AgileAnalyticsPluginPage as A, getEndDate as a, agileAnalyticsApiRef as b, getUniqueListByParent as c, agileAnalyticsPluginPlugin as d, getStartDate as g };
//# sourceMappingURL=index-f30f7d6a.esm.js.map
